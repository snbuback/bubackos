...
python3 tools/build.py -v --clean --debug --lto=off --jerry-libc=off --jerry-cmdline=off --jerry-libm=off --cpointer-32bit=on --toolchain=/tools/toolchain_bubackos.cmake
