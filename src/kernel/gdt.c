...
/* TODO Fixme the size of gdt */
/* Our GDT, with 100 entries, and finally our special GDT pointer */
struct gdt_entry gdt[100];
struct gdt_ptr _gp;
...
void gdt_install()
{
	...
	gdt_set_gate(1, 0, 0xFFFFFFFF, 0b10101001, 0xCF);

	/* The third entry is our Data Segment.  It's exactly the
	 * same as our code segment, but the descriptor type in
	 * this entry's access byte says it's a Data Segment */
	gdt_set_gate(2, 0, 0xFFFFFFFF, 0b10101001, 0xCF);
